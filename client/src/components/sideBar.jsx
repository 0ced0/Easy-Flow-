...
export default function SideBar () {
    return(
        <div className="bg-white h-[97.5vh] shadow-[0px_1px_4px_1px_rgba(0,0,0,0.25)] w-[3vw] p-1 flex flex-col gap-6">
            <NavLink to={"/"}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className=" sideBarIcons size-9 hover:bg-black/20">
            ...
            <NavLink to={"/traffic_light_controls_page"}>
                <svg className="sideBarIcons hover:bg-black/20" 
