                    ...
                    {Object.entries(violationData).map(([vehicleId, violationInformation]) => {
                        return(
                            <div className="listItemContainer"
                                ...
                                <p className="vmViolation">{violationInformation.violation_type === 2 ? "Illegal Parking" : violationInformation.violationType === 1 ? "Illegal Loading/Unloading" : ""}</p>
                                </div>
                                ...
                                violationInformation.violationType === 1 ? <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="orange" class="size-5 mb-auto">
